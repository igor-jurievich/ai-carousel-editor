export const MIN_SLIDES_COUNT = 6;
export const MAX_SLIDES_COUNT = 10;
export const DEFAULT_SLIDES_COUNT = 8;
export const SLIDES_COUNT_OPTIONS = [6, 7, 8, 9, 10] as const;
export const MAX_TOPIC_CHARS = 800;
